...
//     const authLinks =(
//         <a className='navbar_top_auth_link' onClick={logout} href="#!">Logout</a>
//     );

//     const guestLinks = (
//         <Fragment>
//             <Link className='navbar_top_auth_link' to='/login'>Login</Link>
...
//                         <Link className='navbar_top_logo_link' to='/'>Realest Estate</Link>
//                     </div>
