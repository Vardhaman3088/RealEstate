...
const Listingdetails = (props) =>{
    ...
    useEffect(() =>{
        ...
        if(id){
            axios.get(`http://localhost:8000/api/realtor/${id}`,config)
            .then(res =>{
                setRealtor(res.data);
            })
            .catch(err =>{
        ...
        <div className='listingdetail'>
            ...
            <div className='row'>
                <div className='col-3-of-4'>
                    <div className='listingdetail_display'>
                        <img className='listingdetail_display_image' src={listing.photo_main} alt='' />
                    </div>
                </div>
                <div className='col-1-of-4'>
                    <div className='listingdetail_display'>
                        <img className='listingdetail_display_image' src={realtor.photo} alt='' />
                    </div>
                    <h3 className='listingdetail_realtor' >{realtor.name}</h3>
                    <p className='listingdetail_contact' >{realtor.photo}</p>
            ...
            <div className='row'>
                ...
                <div className='col-1-of-2'>
                    <ul className='listingdetail_list'>
                        ...
                        <li className='listingdetail_list_item'>City: {listing.city}y</li> 
